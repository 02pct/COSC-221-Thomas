Hello! My name is Peyton Thomas and I am currently a senior undergraduate math major taking COSC 221 at Coppin State University taught by Dr. Ronak Nouri. The follow is my description about the simple project I uploaded and how to run it. 

The project file titled "test-projects" is a java project that cotains one file by the same name. The file itself is a program that takes the user input and outputs the day of the week corresponding to the days of the week of the Gregorian calendar. The user input is an integer, then the integer goes into the switch decision statement that is divides into cases based on the day of the week, then it output the corresponding day of the week. 
